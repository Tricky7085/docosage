    ...
    return (
        <main className={classes.main}>
            ...
            <div className={classes.buttonContainer}>
                <button className={classes.nextButton} disabled={!gender}  onClick={handleNext}>Next</button>
                <button className={classes.skipButton}>Skip</button>
            </div>
            {error && <p className={classes.error} onClick={()=>router.push('/userInfo/height')}>{error}</p>}
